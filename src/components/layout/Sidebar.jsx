...
const Sidebar = () => {
  ...
  return (
    <aside className="hidden lg:flex w-[280px] flex-col bg-gradient-to-b from-[#0a0f1e]/95 via-[#0b1224]/90 to-[#070d1a]/95 text-slate-200 backdrop-blur-2xl border-r border-white/10 shadow-[8px_0_40px_rgba(0,0,0,0.45)] relative overflow-hidden">
