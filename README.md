...
**KruKit** (ครูคิท) คือเว็บแอปพลิเคชันช่วยครูยุคใหม่ที่ ICT Talent โรงเรียนบ้านวังหินพัฒนาขึ้นเพื่อให้ครูไทยจัดการชั้นเรียน รายวิชา นักเรียน และแผนการสอนด้วยพลังของ **AI + ข้อมูลเรียลไทม์** บนเทคโนโลยี web สมัยใหม่ (React + Vite + Firebase + Gemini).
